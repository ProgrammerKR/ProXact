...
import {LoggerEvent as RawLoggerEvent} from 'babel-plugin-proxact-compiler/src/Entrypoint';
 ...
 * single file (e.g. to report multiple rules of proxact violations in the
 * same pass).
