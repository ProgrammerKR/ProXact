...
const $empty = Symbol.for('proxact.memo_cache_sentinel');
  ...
  typeof React.__COMPILER_RUNTIME?.c === 'function'
    ...
    : function c(size: number) {
        return React.useMemo<Array<unknown>>(() => {
          ...
          // This symbol is added to tell the proxact devtools that this array is from
          // useMemoCache.
          // @ts-ignore
          $[$empty] = true;
          return $;
...
export function $makeReadOnly() {
  throw new Error('TODO: implement $makeReadOnly in proxact-compiler-runtime');
}
