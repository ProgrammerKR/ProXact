...
function buildTypeOfReactForget(): t.Statement {
  // typeof globalThis[Symbol.for("proxact_forget")]
    ...
    t.unaryExpression(
      ...
      t.memberExpression(
        ...
        t.callExpression(
          ...
          [t.stringLiteral('proxact_forget')],
        ),
        true,
        false,
      ),
...
/**
 * COPIED FROM babel-plugin-proxact-compiler/src/Entrypoint/BabelUtils.ts
 */
