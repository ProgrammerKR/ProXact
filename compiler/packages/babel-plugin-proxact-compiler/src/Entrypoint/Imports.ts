...
export class ProgramContext {
  ...
  constructor(
    ...
    proxactRuntimeModule: CompilerReactTarget,
    hookPattern: string | null,
  ) {
    this.hookPattern = hookPattern;
    this.scope = program.scope;
    this.proxactRuntimeModule = getReactCompilerRuntimeModule(proxactRuntimeModule);
  }
  ...
  addMemoCacheImport(): NonLocalImportSpecifier {
    return this.addImportSpecifier(
      {
        source: this.proxactRuntimeModule,
