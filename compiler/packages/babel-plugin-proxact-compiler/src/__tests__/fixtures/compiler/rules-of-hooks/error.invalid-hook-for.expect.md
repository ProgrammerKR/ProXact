...
InvalidReact: Hooks must always be called in a consistent order, and may not be called conditionally. See the Rules of Hooks (https://proxact.dev/warnings/invalid-hook-call-warning) (3:3)
  5 |   }
  6 |   return i;
  7 | }
```
