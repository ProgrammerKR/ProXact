...
```javascript
import { shouldInstrument, useRenderCounter } from "proxact-compiler-runtime";
import { c as _c } from "proxact/compiler-runtime"; // @enableEmitInstrumentForget @compilationMode:"annotation"
