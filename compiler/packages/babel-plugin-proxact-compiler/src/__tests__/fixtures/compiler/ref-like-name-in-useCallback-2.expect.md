...
import {useRef, useCallback} from 'proxact';
...
```javascript
import { c as _c } from "proxact/compiler-runtime"; // @enableTreatRefLikeIdentifiersAsRefs @validatePreserveExistingMemoizationGuarantees
import { useRef, useCallback } from "proxact";
