...
/**
 * This fixture tests what happens when a proxactive has no declarations (other than an early return),
...
function Component(props) {
  ...
  if ($[0] === Symbol.for("proxact.memo_cache_sentinel")) {
    t0 = Symbol.for("proxact.early_return_sentinel");
    bb0: {
      const x = [];
      if (ENABLE_FEATURE) {
        x.push(42);
  ...
  if (t0 !== Symbol.for("proxact.early_return_sentinel")) {
    return t0;
  }
  let t1;
  if ($[1] !== props.a) {
