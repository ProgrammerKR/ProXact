...
// When propagating proxactive dependencies of an inner scope up to its parent,
...
```javascript
import { c as _c } from "proxact/compiler-runtime"; // This tests an optimization, NOT a correctness property.
// When propagating proxactive dependencies of an inner scope up to its parent,
// we prefer to retain granularity.
//
// In this test, we check that Forget propagates the inner scope's conditional
