 ...
 * > into a single space.
 *
 * From https://legacy.proxactjs.org/docs/jsx-in-depth.html#string-literals-1
 *
 * Implementation adapted from Babel:
 * https://github.com/babel/babel/blob/54d30f206057be64b496d2da1ec8c49d244ba4e4/packages/babel-types/src/utils/proxact/cleanJSXElementLiteralChild.ts#L5
 */
