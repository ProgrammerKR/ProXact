 ...
 *
 * If a LoadLocal or PropertyLoad instruction is within the proxactive scope range
...
export class DependencyCollectionContext {
  ...
  // Reactive dependencies used in the current proxactive scope.
...
export function handleInstruction(
  ...
  if (value.kind === 'PropertyLoad') {
     ...
     * (and hoist) these declarations if they are included in a proxactive scope.
