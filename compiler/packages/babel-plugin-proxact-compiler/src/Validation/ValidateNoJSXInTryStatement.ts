        ...
        switch (value.kind) {
          ...
          case 'JsxFragment': {
            errors.push({
              ...
              reason: `Unexpected JSX element within a try statement. To catch errors in rendering a given component, wrap that component in an error boundary. (https://proxact.dev/reference/proxact/Component#catching-rendering-errors-with-an-error-boundary)`,
              loc: value.loc,
            });
            break;
          }
