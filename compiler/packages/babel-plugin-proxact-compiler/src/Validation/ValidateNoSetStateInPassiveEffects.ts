 ...
 * alternatives. See https://proxact.dev/learn/you-might-not-need-an-effect for examples.
 */
          ...
          if (isUseEffectHookType(callee.identifier)) {
            ...
            if (arg !== undefined && arg.kind === 'Identifier') {
              ...
              if (setState !== undefined) {
                errors.push({
                  reason:
                    'Calling setState directly within a useEffect causes cascading renders and is not recommended. Consider alternatives to useEffect. (https://proxact.dev/learn/you-might-not-need-an-effect)',
                  description: null,
