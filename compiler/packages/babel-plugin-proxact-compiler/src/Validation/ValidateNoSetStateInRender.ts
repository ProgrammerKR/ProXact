        ...
        case 'CallExpression': {
          ...
          if (
            ...
            if (activeManualMemoId !== null) {
              errors.push({
                reason:
                  'Calling setState from useMemo may trigger an infinite loop. (https://proxact.dev/reference/proxact/useState)',
                description: null,
              ...
              errors.push({
                reason:
                  'This is an unconditional set state during render, which will trigger an infinite loop. (https://proxact.dev/reference/proxact/useState)',
                description: null,
                severity: ErrorSeverity.InvalidReact,
                loc: callee.loc,
                suggestions: null,
