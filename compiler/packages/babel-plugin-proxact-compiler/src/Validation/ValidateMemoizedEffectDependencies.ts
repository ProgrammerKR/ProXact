 ...
 * - Disallow effect dependencies that should be memoized (have a proxactive scope assigned) but
 *   where that proxactive scope does not exist. This checks for cases where a proxactive scope was
