    ...
    for (const instr of block.instructions) {
      ...
      if (value.kind === 'MethodCall' || value.kind == 'CallExpression') {
        ...
        if (signature != null && signature.impure === true) {
          errors.push({
            reason:
              'Calling an impure function can produce unstable results. (https://proxact.dev/reference/rules/components-and-hooks-must-be-pure#components-and-hooks-must-be-idempotent)',
            description:
