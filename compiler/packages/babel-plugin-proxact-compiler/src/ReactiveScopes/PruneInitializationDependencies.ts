 ...
 *
 * Algorithm:
 * We take two passes over the proxactive function AST. In the first pass, we gather
 ...
 *
 * Whenever we finish this reverse pass over a proxactive block, we can look at the blocks
