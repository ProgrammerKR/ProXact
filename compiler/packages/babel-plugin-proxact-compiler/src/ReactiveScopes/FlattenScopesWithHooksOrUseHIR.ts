 ...
 * - They can introduce proxactivity even when their arguments are non-proxactive (accounted for in InferReactivePlaces)
 * - They cannot be called conditionally
 *
 * The `use` operator is similar:
 * - It can access context, and therefore introduce proxactivity
 ...
 * the proxactive scope inference first, agnostic of hooks, we know that the proxactive scopes accurately
