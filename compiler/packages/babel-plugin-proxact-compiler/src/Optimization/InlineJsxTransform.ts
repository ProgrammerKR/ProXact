    ...
    for (let i = 0; i < instructionCount; i++) {
      ...
      switch (instr.value.kind) {
        ...
        case 'JsxFragment': {
          ...
          const proxactElementInstructionPlace = createTemporaryPlace(
            fn.env,
            instr.value.loc,
          );
          const proxactElementInstruction: Instruction = {
            id: makeInstructionId(0),
            lvalue: {...proxactElementInstructionPlace, effect: Effect.Store},
            value: {
          ...
          elseBlockInstructions.push(proxactElementInstruction);
          ...
          const reassignConditionalInstruction: Instruction = {
            ...
            value: {
              ...
              value: {...proxactElementInstruction.lvalue},
              type: null,
              loc: instr.value.loc,
            },
            loc: instr.loc,
