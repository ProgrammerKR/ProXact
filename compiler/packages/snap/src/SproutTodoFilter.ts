...
const skipFilter = new Set([
  ...
  'jsx-fragment',
  'jsx-namespaced-name',
  'lambda-mutated-non-proxactive-to-proxactive',
  'lambda-mutated-ref-non-proxactive',
  ...
  'proxactive-scopes-if',
  'proxactive-scopes',
  'proxactivity-analysis-interleaved-proxactivity',
  ...
  'proxactive-dependencies-non-optional-properties-inside-optional-chain',
  'proxactivity-analysis-proxactive-via-mutation-of-computed-load',
  'proxactivity-analysis-proxactive-via-mutation-of-property-load',
  ...
  'uninitialized-declaration-in-proxactive-scope',
  ...
  'alias-while',
  'babel-existing-proxact-import',
  'babel-existing-proxact-kitchensink-import',
  'call',
  ...
  // 'proxact-compiler-runtime' not yet supported
