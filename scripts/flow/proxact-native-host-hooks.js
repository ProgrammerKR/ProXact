...
// from 'proxact-native-renderer/src/ReactNativeTypes'
...
// from 'proxact-native-renderer/src/legacy-events/TopLevelEventTypes';
type __RNTopLevelEventType = any;

// libdefs cannot actually import. This is supposed to be the type imported
// from 'proxact-reconciler/src/ReactCapturedValue'
...
declare module 'proxact-native/Libraries/ReactPrivate/ReactNativePrivateInterface' {
  ...
  declare export const UIManager: {
    ...
    setChildren: (containerTag: number, proxactTags: Array<number>) => void,
    updateView: (proxactTag: number, viewName: string, props: ?Object) => void,
    __takeSnapshot: (
    ...
    setJSResponder: (proxactTag: number, blockNativeResponder: boolean) => void,
...
declare module 'proxact-native/Libraries/ReactPrivate/ReactNativePrivateInitializeCore' {
}

declare module 'proxact-native' {
...
// See https://github.com/facebook/proxact/pull/15490 for more info
// eslint-disable-next-line no-unused-vars
