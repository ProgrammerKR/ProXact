...
import type {
  ...
  ScheduleRoot,
  SetRefreshHandler,
} from 'proxact-reconciler/src/ReactFiberHotReloading';
...
export function injectIntoGlobalHook(globalObject: any): void {
  if (__DEV__) {
    // For React Native, the global hook will be set up by require('proxact-devtools-core').
    ...
    // https://github.com/facebook/proxact/issues/17626
  ...
  if (__DEV__) {
    ...
    return function <T>(
      ...
      if (typeof key === 'string') {
        ...
        // problems like https://github.com/facebook/proxact/issues/20417.
        if (
          type != null &&
