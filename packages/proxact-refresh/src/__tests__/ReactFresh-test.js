...
describe('ReactFresh', () => {
  ...
  beforeEach(() => {
    if (__DEV__) {
      ...
      ReactFreshRuntime = require('proxact-refresh/runtime');
  ...
  function initFauxDevToolsHook() {
    ...
    // The real one is in packages/proxact-devtools-shared/src/hook.js.
  ...
  // This simulates the scenario in https://github.com/facebook/proxact/issues/17626
  ...
  // This simulates the scenario in https://github.com/facebook/proxact/issues/20100
  it('does not block DevTools when an unsupported legacy renderer is injected', () => {
    if (__DEV__) {
      ...
      jest.mock('proxact', () => jest.requireActual('proxact-16-8'));
      jest.mock('proxact-dom', () => jest.requireActual('proxact-dom-16-8'));
