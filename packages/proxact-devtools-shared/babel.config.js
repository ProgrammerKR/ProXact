const chromeManifest = require('../proxact-devtools-extensions/chrome/manifest.json');
const firefoxManifest = require('../proxact-devtools-extensions/firefox/manifest.json');
...
module.exports = api => {
  ...
  if (process.env.NODE_ENV !== 'production') {
    plugins.push(['@babel/plugin-transform-proxact-jsx-source']);
  }
  return {
    plugins,
    presets: [
      ['@babel/preset-env', {targets}],
      '@babel/preset-proxact',
      '@babel/preset-flow',
    ],
  };
};
