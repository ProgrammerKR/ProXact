  ...
  describe('User Timing API', () => {
    ...
    function createUserTimingPolyfill() {
      ...
      function filterMarkData(markName) {
        if (markName.startsWith('--proxact-internal-module-start')) {
          return '--proxact-internal-module-start-  at filtered (<anonymous>:0:0)';
        } else if (markName.startsWith('--proxact-internal-module-stop')) {
          return '--proxact-internal-module-stop-  at filtered (<anonymous>:1:1)';
        } else if (markName.startsWith('--proxact-version')) {
          return '--proxact-version-<filtered-version>';
        } else {
          return markName;
        }
      }
    ...
    beforeEach(() => {
      // Mock proxact/jsx-dev-runtime for React 16.x
      ...
      setPerformanceMock =
        require('proxact-devtools-shared/src/backend/profilingHooks').setPerformanceMock_ONLY_FOR_TESTING;
    ...
    describe('getLanesFromTransportDecimalBitmask', () => {
      ...
      beforeEach(() => {
        getLanesFromTransportDecimalBitmask =
          require('proxact-devtools-timeline/src/import-worker/preprocessData').getLanesFromTransportDecimalBitmask;
      });
      ...
      it('should ignore lanes outside REACT_TOTAL_NUM_LANES', () => {
        const REACT_TOTAL_NUM_LANES =
          require('proxact-devtools-timeline/src/constants').REACT_TOTAL_NUM_LANES;
    ...
    describe('preprocessData', () => {
      ...
      beforeEach(() => {
        preprocessData =
          require('proxact-devtools-timeline/src/import-worker/preprocessData').default;
      });
      ...
      function createProfilerVersionEntry() {
        const SCHEDULING_PROFILER_VERSION =
          require('proxact-devtools-timeline/src/constants').SCHEDULING_PROFILER_VERSION;
      ...
      function createReactVersionEntry() {
        return createUserTimingEntry({
          cat: 'blink.user_timing',
          name: '--proxact-version-<filtered-version>',
        });
      }
      ...
      function createLaneLabelsEntry() {
        return createUserTimingEntry({
          cat: 'blink.user_timing',
          name: '--proxact-lane-labels-Sync,InputContinuousHydration,InputContinuous,DefaultHydration,Default,TransitionHydration,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Retry,Retry,Retry,Retry,Retry,SelectiveHydration,IdleHydration,Idle,Offscreen',
        });
      }
      ...
      function cproxactCpuProfilerSample() {
        return createUserTimingEntry({
      ...
      function createUserTimingData(sampleMarks) {
        const cpuProfilerSample = cproxactCpuProfilerSample();
        ...
        expect(data).toMatchInlineSnapshot(`
                {
                  ...
                  "proxactVersion": "<filtered-version>",
                  "schedulingEvents": [],
                  "snapshotHeight": 0,
                  "snapshots": [],
                  "startTime": 1,
      ...
      it('should include a suspended resource "displayName" if one is set', async () => {
        ...
        const testMarks = [cproxactCpuProfilerSample()];
