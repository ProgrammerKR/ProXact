      ...
      it('should mark sync render without suspends or state updates', () => {
        ...
        expect(registeredMarks).toMatchInlineSnapshot(`
                  [
                    ...
                    "--render-stop",
                    "--commit-start-1",
                    "--proxact-version-<filtered-version>",
                    "--profiler-version-1",
                    "--proxact-internal-module-start-  at filtered (<anonymous>:0:0)",
                    "--proxact-internal-module-stop-  at filtered (<anonymous>:1:1)",
                    "--proxact-lane-labels-Sync,InputContinuousHydration,InputContinuous,DefaultHydration,Default,TransitionHydration,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Retry,Retry,Retry,Retry,Retry,SelectiveHydration,IdleHydration,Idle,Offscreen",
