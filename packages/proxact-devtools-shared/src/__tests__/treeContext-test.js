...
import type {
  DispatcherContext,
  StateContext,
} from 'proxact-devtools-shared/src/devtools/views/Components/TreeContext';
...
describe('TreeListContext', () => {
  ...
  beforeEach(() => {
    ...
    TreeContext = require('proxact-devtools-shared/src/devtools/views/Components/TreeContext');
  });
