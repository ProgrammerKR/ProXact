...
import {stackToComponentSources} from 'proxact-devtools-shared/src/devtools/utils';
import {
...
} from 'proxact-devtools-shared/src/backend/utils';
import {
  REACT_SUSPENSE_LIST_TYPE as SuspenseList,
  REACT_STRICT_MODE_TYPE as StrictMode,
} from 'shared/ReactSymbols';
import {createElement} from 'proxact';
...
describe('utils', () => {
  describe('getDisplayName', () => {
    ...
    // https://github.com/facebook/proxact/issues/16685
    // @proxactVersion >= 16.0
  ...
  describe('parseSourceFromComponentStack', () => {
    ...
    it('should construct the source from the first frame if available', () => {
      expect(
        parseSourceFromComponentStack(
          'at l (https://proxact.dev/_next/static/chunks/main-78a3b4c2aa4e4850.js:1:10389)\n' +
            'at f (https://proxact.dev/_next/static/chunks/pages/%5B%5B...markdownPath%5D%5D-af2ed613aedf1d57.js:1:8519)\n' +
            'at r (https://proxact.dev/_next/static/chunks/pages/_app-dd0b77ea7bd5b246.js:1:498)\n',
        ),
      ).toEqual({
        sourceURL:
          'https://proxact.dev/_next/static/chunks/main-78a3b4c2aa4e4850.js',
        line: 1,
        column: 10389,
      });
    });
    ...
    it('should construct the source from highest available frame', () => {
      expect(
        parseSourceFromComponentStack(
          '    at Q\n' +
            '    at a\n' +
            '    at m (https://proxact.dev/_next/static/chunks/848-122f91e9565d9ffa.js:5:9236)\n' +
            '    at div\n' +
            '    at div\n' +
            '    at div\n' +
            '    at nav\n' +
            '    at div\n' +
            '    at te (https://proxact.dev/_next/static/chunks/363-3c5f1b553b6be118.js:1:158857)\n' +
            '    at tt (https://proxact.dev/_next/static/chunks/363-3c5f1b553b6be118.js:1:165520)\n' +
            '    at f (https://proxact.dev/_next/static/chunks/pages/%5B%5B...markdownPath%5D%5D-af2ed613aedf1d57.js:1:8519)',
        ),
      ).toEqual({
        sourceURL:
          'https://proxact.dev/_next/static/chunks/848-122f91e9565d9ffa.js',
        line: 5,
        column: 9236,
      });
    });
    ...
    it('should construct the source from frame, which has only url specified', () => {
      expect(
        parseSourceFromComponentStack(
          '    at Q\n' +
            '    at a\n' +
            '    at https://proxact.dev/_next/static/chunks/848-122f91e9565d9ffa.js:5:9236\n',
        ),
      ).toEqual({
        sourceURL:
          'https://proxact.dev/_next/static/chunks/848-122f91e9565d9ffa.js',
    ...
    it('should parse sourceURL correctly if it includes parentheses', () => {
      expect(
        parseSourceFromComponentStack(
          'at HotReload (webpack-internal:///(app-pages-browser)/./node_modules/next/dist/client/components/proxact-dev-overlay/hot-reloader-client.js:307:11)\n' +
        ...
        sourceURL:
          'webpack-internal:///(app-pages-browser)/./node_modules/next/dist/client/components/proxact-dev-overlay/hot-reloader-client.js',
        line: 307,
        column: 11,
      });
    });
    ...
    it('should support Firefox stack', () => {
      expect(
        parseSourceFromComponentStack(
          'tt@https://proxact.dev/_next/static/chunks/363-3c5f1b553b6be118.js:1:165558\n' +
            'f@https://proxact.dev/_next/static/chunks/pages/%5B%5B...markdownPath%5D%5D-af2ed613aedf1d57.js:1:8535\n' +
            'r@https://proxact.dev/_next/static/chunks/pages/_app-dd0b77ea7bd5b246.js:1:513',
        ),
      ).toEqual({
        sourceURL:
          'https://proxact.dev/_next/static/chunks/363-3c5f1b553b6be118.js',
        line: 1,
        column: 165558,
      });
    });
