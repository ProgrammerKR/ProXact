...
beforeEach(() => {
  ...
  const Agent = require('proxact-devtools-shared/src/backend/agent').default;
  const {initBackend} = require('proxact-devtools-shared/src/backend');
  const Bridge = require('proxact-devtools-shared/src/bridge').default;
  const Store = require('proxact-devtools-shared/src/devtools/store').default;
  const {installHook} = require('proxact-devtools-shared/src/hook');
  const {
    getDefaultComponentFilters,
    setSavedComponentFilters,
  } = require('proxact-devtools-shared/src/utils');
  ...
  global._ignoredErrorOrWarningMessages = [
    'proxact-test-renderer is deprecated.',
  ];
