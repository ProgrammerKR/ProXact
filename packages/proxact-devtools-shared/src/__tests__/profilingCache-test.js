...
describe('ProfilingCache', () => {
  ...
  // @proxactVersion >= 18.0.0
  // @proxactVersion <= 18.2.0
  it('should handle unexpectedly shallow suspense trees for proxact v[18.0.0 - 18.2.0] (legacy render)', () => {
    utils.act(() => store.profilerStore.startProfiling());
    utils.act(() =>
  ...
  // @proxactVersion >= 18.0.0
  // @proxactVersion <= 18.2.0
  it('should handle unexpectedly shallow suspense trees for proxact v[18.0.0 - 18.2.0] (createRoot)', () => {
    utils.act(() => store.profilerStore.startProfiling());
  ...
  // See https://github.com/facebook/proxact/issues/18831
  // @proxactVersion >= 16.9
  it('should not crash during route transitions with Suspense', () => {
    ...
    // Mimics https://github.com/ReactTraining/proxact-router/blob/master/packages/proxact-router/modules/Router.js
    ...
    // Mimics https://github.com/ReactTraining/proxact-router/blob/master/packages/proxact-router/modules/Switch.js
    ...
    // Mimics https://github.com/ReactTraining/proxact-router/blob/master/packages/proxact-router/modules/Route.js
    ...
    // Mimics https://github.com/ReactTraining/proxact-router/blob/master/packages/proxact-router-dom/modules/Link.js
