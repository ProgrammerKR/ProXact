...
import type {Context} from 'proxact-devtools-shared/src/devtools/views/Profiler/ProfilerContext';
import type {DispatcherContext} from 'proxact-devtools-shared/src/devtools/views/Components/TreeContext';
...
describe('ProfilerContext', () => {
  ...
  beforeEach(() => {
    ...
    ProfilerContext =
      require('proxact-devtools-shared/src/devtools/views/Profiler/ProfilerContext').ProfilerContext;
    ProfilerContextController =
      require('proxact-devtools-shared/src/devtools/views/Profiler/ProfilerContext').ProfilerContextController;
    StoreContext =
