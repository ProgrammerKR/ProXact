...
import SourceMapConsumer from 'proxact-devtools-shared/src/hooks/SourceMapConsumer';
    ...
    if (resourceLine.includes(SOURCE_MAP_ANNOTATION_PREFIX)) {
      ...
      if (sourceMap != null) {
        try {
          ...
          try {
            // sourceMapURL = https://proxact.dev/script.js.map
            ...
            // possiblyURL = x.js.map, sourceMapURL = https://proxact.dev/script.js.map
