...
import {withSyncPerfMeasurements} from 'proxact-devtools-shared/src/PerformanceLoggingUtils';
import traverse from '@babel/traverse';

import type {HooksNode} from 'proxact-debug-tools/src/ReactDebugHooks';
...
function checkNodeLocation(
  ...
  if (column !== null) {
    ...
    //
    // For more info see https://github.com/facebook/proxact/pull/21833#discussion_r666831276
    column -= 1;
    if (
...
// Copied from packages/eslint-plugin-proxact-hooks/src/RulesOfHooks
