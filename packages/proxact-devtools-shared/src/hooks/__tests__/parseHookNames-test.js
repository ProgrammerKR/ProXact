...
describe('parseHookNames', () => {
  ...
  beforeEach(() => {
    ...
    inspectHooks =
      require('proxact-debug-tools/src/ReactDebugHooks').inspectHooks;
  ...
  describe('inline, external and bundle source maps', () => {
    ...
    // TODO Inline require (e.g. require("proxact").useState()) isn't supported yet.
  ...
  describe('extended source maps', () => {
    ...
    it('should work for simple components', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/Example',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/Example',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/Example',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/Example',
      ); // x_proxact_sources extended external index map source map
    ...
    it('should work with more complex files and components', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/ToDoList',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/ToDoList',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/ToDoList',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/ToDoList',
      ); // x_proxact_sources extended external index map source map
    ...
    it('should work for custom hook', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/ComponentWithCustomHook',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/ComponentWithCustomHook',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/ComponentWithCustomHook',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/ComponentWithCustomHook',
      ); // x_proxact_sources extended external index map source map
    ...
    it('should work when code is using hooks indirectly', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/ComponentUsingHooksIndirectly',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/ComponentUsingHooksIndirectly',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/ComponentUsingHooksIndirectly',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/ComponentUsingHooksIndirectly',
      ); // x_proxact_sources extended external index map source map
    ...
    it('should work when code is using nested hooks', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/ComponentWithNestedHooks',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/ComponentWithNestedHooks',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/ComponentWithNestedHooks',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/ComponentWithNestedHooks',
      ); // x_proxact_sources extended external index map source map
    ...
    it('should work for external hooks', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/ComponentWithExternalCustomHooks',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/ComponentWithExternalCustomHooks',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/ComponentWithExternalCustomHooks',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/ComponentWithExternalCustomHooks',
      ); // x_proxact_sources extended external index map source map
    ...
    it('should work when multiple hooks are on a line', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/ComponentWithMultipleHooksPerLine',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/ComponentWithMultipleHooksPerLine',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/ComponentWithMultipleHooksPerLine',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/ComponentWithMultipleHooksPerLine',
      ); // x_proxact_sources extended external index map source map
    ...
    it.skip('should work for inline requires', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/InlineRequire',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/InlineRequire',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/InlineRequire',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/InlineRequire',
      ); // x_proxact_sources extended external index map source map
    ...
    it('should support sources that contain the string "sourceMappingURL="', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/ContainingStringSourceMappingURL',
      ); // x_proxact_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/ContainingStringSourceMappingURL',
      ); // x_proxact_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/proxact-sources-extended/index-map/ContainingStringSourceMappingURL',
      ); // x_proxact_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/proxact-sources-extended/index-map/ContainingStringSourceMappingURL',
      ); // x_proxact_sources extended external index map source map
