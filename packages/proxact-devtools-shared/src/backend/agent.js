...
import type {ComponentFilter} from 'proxact-devtools-shared/src/frontend/types';
...
export default class Agent extends EventEmitter<{
  ...
  inspectElement: InspectElementParams => void = ({
    ...
    if (renderer == null) {
      ...
      // https://github.com/bvaughn/proxact-devtools-experimental/issues/102
  ...
  onHookOperations: (operations: Array<number>) => void = operations => {
    ...
    //
    // See bug https://github.com/bvaughn/proxact-devtools-experimental/issues/25
    //
