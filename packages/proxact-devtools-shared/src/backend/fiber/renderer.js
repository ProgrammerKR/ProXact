...
import {inspectHooksOfFiber} from 'proxact-debug-tools';
import {
...
import {enableStyleXFeatures} from 'proxact-devtools-feature-flags';
  ...
  function shouldFilterFiber(fiber: Fiber): boolean {
    ...
    switch (tag) {
      case DehydratedSuspenseComponent:
        ...
        // https://github.com/bvaughn/proxact-devtools-experimental/issues/197
        return true;
      case HostPortal:
      case HostText:
      case LegacyHiddenComponent:
    ...
    /* DISABLED: https://github.com/facebook/proxact/pull/28417
    ...
    try {
      ...
      if (error.name === 'ReactDebugToolsUnsupportedHookError') {
        return {
          ...
          responseID: requestID,
          message:
            'Unsupported hook in the proxact-debug-tools package: ' +
            error.message,
        };
      }
