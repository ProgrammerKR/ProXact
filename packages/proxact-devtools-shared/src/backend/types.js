...
} from 'proxact-devtools-shared/src/backend/NativeStyleEditor/setupNativeStyleEditor';
import type {InitBackend} from 'proxact-devtools-shared/src/backend';
import type {TimelineDataExport} from 'proxact-devtools-timeline/src/types';
import type {BackendBridge} from 'proxact-devtools-shared/src/bridge';
...
export type DevToolsHook = {
  ...
  proxactDevtoolsAgent?: ?Object,
  sub: (event: string, handler: Handler) => () => void,

  // Used by proxact-native-web and Flipper/Inspector
