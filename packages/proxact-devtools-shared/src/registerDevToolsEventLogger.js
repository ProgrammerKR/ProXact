...
import type {LoggerEvent} from 'proxact-devtools-shared/src/Logger';

import {registerEventLogger} from 'proxact-devtools-shared/src/Logger';
import {enableLogger} from 'proxact-devtools-feature-flags';
    ...
    if (enableLogger) {
      if (currentLoggingIFrame != null && currentSessionId != null) {
        ...
        currentLoggingIFrame?.contentWindow?.postMessage(
          {
            source: 'proxact-devtools-logging',
