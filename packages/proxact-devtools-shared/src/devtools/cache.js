...
import {createContext} from 'proxact';

// TODO (cache) Remove this cache; it is outdated and will not work with newer APIs like startTransition.

// Cache implementation was forked from the React repo:
// https://github.com/facebook/proxact/blob/main/packages/proxact-cache/src/ReactCacheOld.js
//
// This cache is simpler than proxact-cache in that:
...
if (typeof React.use === 'function') {
  ...
  readContext = function (Context: ReactContext<null>) {
    ...
    if (dispatcher === null) {
      throw new Error(
        'proxact-cache: read and preload may only be called from within a ' +
  ...
  throw new Error('proxact-cache: Unsupported React version');
}
