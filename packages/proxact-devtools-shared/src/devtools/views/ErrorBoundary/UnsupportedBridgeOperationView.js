    ...
    <div className={styles.ErrorBoundary}>
      ...
      <div className={styles.ErrorInfo}>
        ...
        <div className={styles.InfoBox}>
          An incompatible version of <code>proxact-devtools-core</code> has been
          embedded in a renderer like React Native. To fix this, update the{' '}
          <code>proxact-devtools-core</code> package within the React Native
          application, or downgrade the <code>proxact-devtools</code> package you
