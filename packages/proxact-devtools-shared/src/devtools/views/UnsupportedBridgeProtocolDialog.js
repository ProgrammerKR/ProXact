...
import {Fragment, useContext, useEffect} from 'proxact';
import {ModalDialogContext} from './ModalDialog';
import {StoreContext} from './context';
import {currentBridgeProtocol} from 'proxact-devtools-shared/src/bridge';
import Button from './Button';
import ButtonIcon from './ButtonIcon';
import {copy} from 'clipboard-js';
import styles from './UnsupportedBridgeProtocolDialog.css';
import {withPermissionsCheck} from 'proxact-devtools-shared/src/frontend/utils/withPermissionsCheck';

import type {BridgeProtocol} from 'proxact-devtools-shared/src/bridge';
...
function DialogContent({
  ...
  if (maxNpmVersion === null) {
    const upgradeInstructions = `npm i -g proxact-devtools@^${minNpmVersion}`;
    instructions = (
      <>
    ...
    const downgradeInstructions = `npm i -g proxact-devtools@${maxNpmVersion}`;
    instructions = (
      <>
        <p className={styles.Paragraph}>
  ...
  return (
    <Fragment>
      <div className={styles.Column}>
        ...
        <p className={styles.Paragraph}>
          You are running <code>proxact-devtools</code> version{' '}
