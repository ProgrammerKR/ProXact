...
import {useCallback, useContext, useState} from 'proxact';
...
import {getHookSourceLocationKey} from 'proxact-devtools-shared/src/hookNamesCache';
import HookNamesModuleLoaderContext from 'proxact-devtools-shared/src/devtools/views/Components/HookNamesModuleLoaderContext';
import isArray from 'proxact-devtools-shared/src/isArray';

import type {InspectedElement} from 'proxact-devtools-shared/src/frontend/types';
import type {HooksNode, HooksTree} from 'proxact-debug-tools/src/ReactDebugHooks';
import type {FrontendBridge} from 'proxact-devtools-shared/src/bridge';
import type {HookNames} from 'proxact-devtools-shared/src/frontend/types';
import type {Element} from 'proxact-devtools-shared/src/frontend/types';
...
function HookView({
  ...
  // Certain hooks are not editable at all (as identified by proxact-debug-tools).
