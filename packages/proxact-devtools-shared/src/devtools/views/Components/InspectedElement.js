...
import {useCallback, useContext, useSyncExternalStore} from 'proxact';
...
import {ElementTypeSuspense} from 'proxact-devtools-shared/src/frontend/types';
import InspectedElementView from './InspectedElementView';
import {InspectedElementContext} from './InspectedElementContext';
import {getOpenInEditorURL} from '../../../utils';
import {LOCAL_STORAGE_OPEN_IN_EDITOR_URL} from '../../../constants';
import FetchFileWithCachingContext from './FetchFileWithCachingContext';
import {symbolicateSourceWithCache} from 'proxact-devtools-shared/src/symbolicateSource';
  ...
  if (element.isStrictModeNonCompliant) {
    strictModeBadge = (
      <a
        ...
        href="https://proxact.dev/reference/proxact/StrictMode"
