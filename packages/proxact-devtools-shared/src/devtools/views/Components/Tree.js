...
import {FixedSizeList} from 'proxact-window';
...
import SettingsModalContextToggle from 'proxact-devtools-shared/src/devtools/views/Settings/SettingsModalContextToggle';
...
import {clearErrorsAndWarnings as clearErrorsAndWarningsAPI} from 'proxact-devtools-shared/src/backendAPI';
import styles from './Tree.css';
import ButtonIcon from '../ButtonIcon';
import Button from '../Button';
import {logEvent} from 'proxact-devtools-shared/src/Logger';
import {useExtensionComponentsPanelVisibility} from 'proxact-devtools-shared/src/frontend/hooks/useExtensionComponentsPanelVisibility';
...
export default function Tree(): React.Node {
  ...
  useEffect(() => {
    ...
    //
    // This approach caused a problem though: it meant that a proxact-devtools-inline
    // instance could steal (and prevent/block) keyboard events from other JavaScript
    // on the page– which could even include other proxact-devtools-inline instances.
  ...
  // Let proxact-window know to re-render any time the underlying tree data changes.
    ...
    <div className={styles.ZeroElementsNotice}>
      ...
      <p>
        ...
        <a
          ...
          href="https://github.com/facebook/proxact/blob/main/packages/proxact-devtools/README.md#the-proxact-tab-shows-no-components"
          target="_blank">
...
function InnerElementType({children, style}) {
  ...
  // See https://github.com/bvaughn/proxact-devtools-experimental/issues/9
  return (
    <div
