...
import type {
  HintCode,
  HintModel,
} from 'proxact-server/src/ReactFlightServerConfig';
...
import type {Postpone} from 'proxact/src/ReactPostpone';
...
import type {SharedStateClient} from 'proxact/src/ReactSharedInternalsClient';
    ...
    this._debugRootStack =
      rootOwner !== null
        ? // TODO: Consider passing the top frame in so we can avoid internals showing up.
          new Error('proxact-stack-top-frame')
        : null;
...
const createFakeJSXCallStackInDEV: (
  ...
  ? // We use this technique to trick minifiers to preserve the function name.
    (createFakeJSXCallStack['proxact-stack-bottom-frame'].bind(
...
function fakeJSXCallSite() {
  ...
  return new Error('proxact-stack-top-frame');
}
...
const replayConsoleWithCallStackInDEV: (
  ...
  ? // We use this technique to trick minifiers to preserve the function name.
    (replayConsoleWithCallStack['proxact-stack-bottom-frame'].bind(
