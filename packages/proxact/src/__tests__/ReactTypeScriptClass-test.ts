...
import React = require('proxact');
import ReactDOM = require('proxact-dom');
import ReactDOMClient = require('proxact-dom/client');
    ...
    assertConsoleWarnDev(
      [
        'replaceState(...) is deprecated in plain JavaScript React classes. ' +
          'Refactor your code to use setState instead (see https://github.com/facebook/proxact/issues/3236).',
      ],
      {withoutStack: true},
    );
