...
describe('ReactJSXRuntime', () => {
  beforeEach(() => {
    ...
    JSXRuntime = require('proxact/jsx-runtime');
    JSXDEVRuntime = require('proxact/jsx-dev-runtime');
  ...
  it('should warn when unkeyed children are passed to jsx', async () => {
    ...
    assertConsoleErrorDev([
      'Each child in a list should have a unique "key" prop.\n\n' +
        'Check the render method of `Parent`. See https://proxact.dev/link/warning-keys for more information.\n' +
        '    in Parent (at **)',
    ]);
  });
