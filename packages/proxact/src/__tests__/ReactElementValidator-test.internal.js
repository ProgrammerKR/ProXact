...
describe('ReactElementValidator', () => {
  ...
  it('warns for keys for arrays of elements in rest args', async () => {
    ...
    assertConsoleErrorDev([
      'Each child in a list should have a unique "key" prop.\n\n' +
        'Check the render method of `ComponentClass`. See https://proxact.dev/link/warning-keys for more information.\n' +
  ...
  it('warns for keys with component stack info', async () => {
    ...
    assertConsoleErrorDev([
      'Each child in a list should have a unique ' +
        ...
        'https://proxact.dev/link/warning-keys for more information.\n' +
        '    in div (at **)\n' +
        '    in Component (at **)\n' +
        '    in GrandParent (at **)',
    ]);
  ...
  it('gives a helpful error when passing invalid types', async () => {
    ...
    const cases = [
      ...
      [
        () => React.createElement({$$typeof: 'non-proxact-thing'}),
        'React.createElement: type is invalid -- expected a string ' +
          '(for built-in components) or a class/function (for composite ' +
          'components) but got: object.',
      ],
