...
describe('create-proxact-class-integration', () => {
  beforeEach(() => {
    jest.resetModules();
    ({
      act,
    ...
    createReactClass = require('create-proxact-class/factory')(
      React.Component,
    ...
    assertConsoleErrorDev(
      [
        'Warning: Something is calling a React component directly. Use a ' +
          'factory or JSX instead. See: https://fb.me/proxact-legacyfactory',
      ],
      {withoutStack: true},
    );
  });
