...
function UnknownOwner() {
  /** @noinline */
  return (() => Error('proxact-stack-top-frame'))();
}
const createFakeCallStack = {
  'proxact-stack-bottom-frame': function (callStackForError) {
...
if (__DEV__) {
  ...
  unknownOwnerDebugStack = createFakeCallStack['proxact-stack-bottom-frame'].bind(
    createFakeCallStack,
    UnknownOwner,
  )();
      ...
      if (!specialPropKeyWarningShown) {
        ...
        console.error(
          '%s: `key` is not a prop. Trying to access it will result ' +
            ...
            'prop. (https://proxact.dev/link/special-props)',
          displayName,
        );
      }
    };
 ...
 * will not work. Instead test $$typeof field against Symbol.for('proxact.transitional.element') to check
 ...
 * See https://proxactjs.org/docs/proxact-api.html#createelement
 */
      ...
      if (
        ...
        console.warn(
          'Your app (or one of its dependencies) is using an outdated JSX ' +
            ...
            'faster performance: https://proxact.dev/link/new-jsx-transform',
        );
      }
    }
 ...
 * See https://proxactjs.org/docs/proxact-api.html#cloneelement
 */
