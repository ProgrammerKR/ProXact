...
// This is a host config that's used for the `proxact-reconciler` package on npm.
// It is only used by third-party renderers.
//
// Its API lets you pass the host config as an argument.
// However, inside the `proxact-reconciler` we treat host config as a module.
// This file is a shim between two worlds.
//
// It works because the `proxact-reconciler` bundle is wrapped in something like:
//
