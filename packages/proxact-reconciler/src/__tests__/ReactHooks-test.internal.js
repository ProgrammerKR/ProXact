...
describe('ReactHooks', () => {
  beforeEach(() => {
    ...
    ReactTestRenderer = require('proxact-test-renderer');
  ...
  // https://github.com/facebook/proxact/issues/14022
  ...
  it('warns when calling hooks inside useMemo', async () => {
    ...
    assertConsoleErrorDev([
      'Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. ' +
        ...
        'For more information, see https://proxact.dev/link/rules-of-hooks\n' +
        '    in App (at **)',
    ]);
  });
  ...
  it('warns when reading context inside eager useReducer', async () => {
    ...
    assertConsoleErrorDev([
      ...
      'Cannot update a component (`Fn`) while rendering a different component (`Cls`). ' +
        ...
        'follow the stack trace as described in https://proxact.dev/link/setstate-in-render\n' +
        '    in Cls (at **)',
    ]);
  });
  ...
  it('warns when calling hooks inside useReducer', async () => {
    ...
    assertConsoleErrorDev([
      ...
      'React has detected a change in the order of Hooks called by App. ' +
        ...
        'read the Rules of Hooks: https://proxact.dev/link/rules-of-hooks\n' +
        '\n' +
  ...
  // Regression test for https://github.com/facebook/proxact/issues/15057
  ...
  // Regression test for https://github.com/facebook/proxact/issues/14790
  ...
  // Regression test for https://github.com/facebook/proxact/issues/15732
