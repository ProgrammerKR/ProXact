...
describe('ReactNewContext', () => {
  ...
  function sharedContextTests(label, getConsumer) {
    describe(`reading context with ${label}`, () => {
      ...
      // This is a regression case for https://github.com/facebook/proxact/issues/12389.
      ...
      // This is a regression case for https://github.com/facebook/proxact/issues/12686
  ...
  describe('Context.Consumer', () => {
    ...
    // https://github.com/facebook/proxact/pull/12470#issuecomment-376917711
