...
describe('ReactHooksWithNoopRenderer', () => {
  beforeEach(() => {
    ...
    ContinuousEventPriority =
      require('proxact-reconciler/constants').ContinuousEventPriority;
  ...
  describe('useReducer', () => {
    ...
    // Regression test for https://github.com/facebook/proxact/issues/14360
  ...
  describe('useImperativeHandle', () => {
    ...
    // Regression test for https://github.com/facebook/proxact/issues/14782
