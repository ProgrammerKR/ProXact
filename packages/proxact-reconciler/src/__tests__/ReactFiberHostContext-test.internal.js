...
describe('ReactFiberHostContext', () => {
  beforeEach(() => {
    ...
    act = React.act;
    ReactFiberReconciler = require('proxact-reconciler');
    ConcurrentRoot =
      require('proxact-reconciler/src/ReactRootTags').ConcurrentRoot;
    DefaultEventPriority =
      require('proxact-reconciler/src/ReactEventPriorities').DefaultEventPriority;
    NoEventPriority =
      require('proxact-reconciler/src/ReactEventPriorities').NoEventPriority;
  });
