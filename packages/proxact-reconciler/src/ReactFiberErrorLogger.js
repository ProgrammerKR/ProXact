...
export function defaultOnUncaughtError(
  ...
  // See https://github.com/facebook/proxact/pull/13384
  ...
  if (__DEV__) {
    ...
    const errorBoundaryMessage =
      ...
      'Visit https://proxact.dev/link/error-boundaries to learn more about error boundaries.';
...
export function logUncaughtError(
  ...
  try {
    ...
    // https://github.com/facebook/proxact/issues/13188
    setTimeout(() => {
      throw e;
    });
  }
