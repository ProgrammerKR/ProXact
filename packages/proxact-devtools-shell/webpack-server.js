...
const makeConfig = (entry, alias) => ({
  ...
  plugins: [
    ...
    new Webpack.DefinePlugin({
      ...
      'process.env.DEVTOOLS_PACKAGE': `"proxact-devtools-shell"`,
...
const app = makeConfig(
  ...
  },
  {
    ...
    'proxact-devtools-feature-flags': resolveFeatureFlags('shell'),
    'proxact-dom/client': resolve(builtModulesDir, 'proxact-dom/unstable_testing'),
...
const e2eRegressionApp = semver.lt(REACT_VERSION, '18.0.0')
  ? makeConfig(
      ...
      {
        proxact: resolve(E2E_APP_BUILD_DIR, 'proxact'),
        'proxact-dom': resolve(E2E_APP_BUILD_DIR, 'proxact-dom'),
  ...
  : makeConfig(
      ...
      },
      {
        proxact: resolve(E2E_APP_BUILD_DIR, 'proxact'),
        'proxact-dom': resolve(E2E_APP_BUILD_DIR, 'proxact-dom'),
        'proxact-dom/client': resolve(E2E_APP_BUILD_DIR, 'proxact-dom/client'),
        scheduler: resolve(E2E_APP_BUILD_DIR, 'scheduler'),
      },
    );
