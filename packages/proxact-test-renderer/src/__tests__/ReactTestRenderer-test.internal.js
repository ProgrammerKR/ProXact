...
const Reconciler = require('proxact-reconciler/src/ReactFiberReconciler');
const {
  ConcurrentRoot,
  LegacyRoot,
} = require('proxact-reconciler/src/ReactRootTags');
...
describe('ReactTestRenderer', () => {
  ...
  it('exposes a type flag', async () => {
    ...
    expect(object.$$typeof).toBe(Symbol.for('proxact.test.json'));
