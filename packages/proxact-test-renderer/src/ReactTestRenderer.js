...
import {findCurrentFiberUsingSlowPath} from 'proxact-reconciler/src/ReactFiberTreeReflection';
import {
  Fragment,
  FunctionComponent,
  ClassComponent,
...
import {ConcurrentRoot, LegacyRoot} from 'proxact-reconciler/src/ReactRootTags';
import {
  ...
  switch (inst.tag) {
    ...
    case 'INSTANCE': {
      ...
      Object.defineProperty(json, '$$typeof', {
        value: Symbol.for('proxact.test.json'),
      });
      return json;
    }
    default:
...
function create(
  ...
  if (__DEV__) {
    if (
      ...
      console.error(
        'proxact-test-renderer is deprecated. See https://proxact.dev/warnings/proxact-test-renderer',
      );
    }
  }
