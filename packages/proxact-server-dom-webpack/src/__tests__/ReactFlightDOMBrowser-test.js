...
describe('ReactFlightDOMBrowser', () => {
  beforeEach(() => {
    ...
    ReactServerDOM = require('proxact-dom');

    jest.mock('proxact-server-dom-webpack/server', () =>
      require('proxact-server-dom-webpack/server.browser'),
    );
    ...
    if (__EXPERIMENTAL__) {
      jest.mock('proxact-server-dom-webpack/static', () =>
        require('proxact-server-dom-webpack/static.browser'),
      );
    ...
    ReactDOMFizzServer = require('proxact-dom/server.browser');
