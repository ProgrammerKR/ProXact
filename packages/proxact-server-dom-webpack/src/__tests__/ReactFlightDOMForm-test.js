...
import {insertNodesAndExecuteScripts} from 'proxact-dom/src/test-utils/FizzTestUtils';
...
describe('ReactFlightDOMForm', () => {
  beforeEach(() => {
    ...
    ReactServerDOMServer = require('proxact-server-dom-webpack/server.edge');
    ...
    ReactServerDOMClient = require('proxact-server-dom-webpack/client.edge');
    ...
    // useActionState = require('proxact-dom').useFormState;
    // }
    useActionState = require('proxact').useActionState;
