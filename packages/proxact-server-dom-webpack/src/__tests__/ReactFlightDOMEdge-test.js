...
describe('ReactFlightDOMEdge', () => {
  beforeEach(() => {
    ...
    proxactServerAct = require('internal-test-utils').serverAct;
    ...
    jest.mock('proxact-server-dom-webpack/server', () =>
      require('proxact-server-dom-webpack/server.edge'),
    );
    ...
    if (__EXPERIMENTAL__) {
      jest.mock('proxact-server-dom-webpack/static', () =>
        require('proxact-server-dom-webpack/static.edge'),
      );
    ...
    jest.mock('proxact-server-dom-webpack/client', () =>
      require('proxact-server-dom-webpack/client.edge'),
    );
    React = require('proxact');
    ReactDOMServer = require('proxact-dom/server.edge');
