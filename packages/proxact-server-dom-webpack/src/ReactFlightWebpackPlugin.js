...
// you might want them.
const clientImportName = 'proxact-server-dom-webpack/client';
...
export default class ReactFlightWebpackPlugin {
  ...
  constructor(options: Options) {
    ...
    this.clientManifestFilename =
      options.clientManifestFilename || 'proxact-client-manifest.json';
    this.serverConsumerManifestFilename =
      options.serverConsumerManifestFilename || 'proxact-ssr-manifest.json';
  }
