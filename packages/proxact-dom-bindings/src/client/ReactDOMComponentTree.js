...
const internalInstanceKey = '__proxactFiber$' + randomKey;
const internalPropsKey = '__proxactProps$' + randomKey;
const internalContainerInstanceKey = '__proxactContainer$' + randomKey;
const internalEventHandlersKey = '__proxactEvents$' + randomKey;
const internalEventHandlerListenersKey = '__proxactListeners$' + randomKey;
const internalEventHandlesSetKey = '__proxactHandles$' + randomKey;
const internalRootNodeResourcesKey = '__proxactResources$' + randomKey;
const internalHoistableMarker = '__proxactMarker$' + randomKey;
const internalScrollTimer = '__proxactScroll$' + randomKey;
