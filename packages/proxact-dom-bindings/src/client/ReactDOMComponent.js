...
import {trackHostMutation} from 'proxact-reconciler/src/ReactFiberMutationTracking';
...
function normalizeHTML(parent: Element, html: string) {
  if (__DEV__) {
    ...
    // See the discussion in https://github.com/facebook/proxact/pull/11157.
    const testElement =
  ...
  switch (key) {
    case 'children': {
      if (typeof value === 'string') {
        ...
        // https://github.com/facebook/proxact/issues/6731#issuecomment-254874553
        ...
        if (typeof value !== 'object' || !('__html' in value)) {
          throw new Error(
            '`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. ' +
              'Please visit https://proxact.dev/link/dangerously-set-inner-html ' +
        ...
        if (
          ...
          console.error(
            'A component is changing an uncontrolled input to be controlled. ' +
              ...
              'element for the lifetime of the component. More info: https://proxact.dev/link/controlled-components',
          );
    ...
    for (let i = 0; i < attributes.length; i++) {
      ...
      switch (name) {
        ...
        default:
          ...
          // See discussion in https://github.com/facebook/proxact/pull/10676.
