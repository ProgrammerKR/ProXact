...
function registerSimpleEvent(domEventName: DOMEventName, proxactName: string) {
  topLevelEventsToReactNames.set(domEventName, proxactName);
  registerTwoPhaseEvent(proxactName, [domEventName]);
}
