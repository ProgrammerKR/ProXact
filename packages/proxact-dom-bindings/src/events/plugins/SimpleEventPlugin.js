...
function extractEvents(
  ...
  const proxactName = topLevelEventsToReactNames.get(domEventName);
  if (proxactName === undefined) {
    return;
  }
  let SyntheticEventCtor = SyntheticEvent;
  let proxactEventType: string = domEventName;
  switch (domEventName) {
    case 'keypress':
  ...
  if (
    ...
    const listeners = accumulateEventHandleNonManagedNodeListeners(
      ...
      ((proxactEventType: any): DOMEventName),
      targetContainer,
      inCapturePhase,
    );
