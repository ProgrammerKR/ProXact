...
const {HostComponent} = require('proxact-reconciler/src/ReactWorkTags');
...
describe('ResponderEventPlugin', () => {
  beforeEach(() => {
    ...
    EventBatching = require('proxact-native-renderer/src/legacy-events/EventBatching');
    EventPluginUtils = require('proxact-native-renderer/src/legacy-events/EventPluginUtils');
    ResponderEventPlugin =
      require('proxact-native-renderer/src/legacy-events/ResponderEventPlugin').default;
  ...
  it(
    ...
    async () => {
      ...
      const ReactDOMClient = require('proxact-dom/client');
      const act = require('internal-test-utils').act;
      const getLowestCommonAncestor =
        require('proxact-native-renderer/src/legacy-events/ResponderEventPlugin').getLowestCommonAncestor;
      // This works by accident and will likely break in the future.
      const ReactDOMComponentTree = require('proxact-dom-bindings/src/client/ReactDOMComponentTree');
