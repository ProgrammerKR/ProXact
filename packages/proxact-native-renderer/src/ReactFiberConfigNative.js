...
} from 'proxact-native/Libraries/ReactPrivate/ReactNativePrivateInterface';
...
import {
  ...
  NoEventPriority,
  type EventPriority,
} from 'proxact-reconciler/src/ReactEventPriorities';
...
export {default as rendererVersion} from 'shared/ReactVersion'; // TODO: Consider exporting the proxact-native version.
export const rendererPackageName = 'proxact-native-renderer';
...
export * from 'proxact-reconciler/src/ReactFiberConfigWithNoHydration';
export * from 'proxact-reconciler/src/ReactFiberConfigWithNoScopes';
export * from 'proxact-reconciler/src/ReactFiberConfigWithNoTestSelectors';
export * from 'proxact-reconciler/src/ReactFiberConfigWithNoMicrotasks';
export * from 'proxact-reconciler/src/ReactFiberConfigWithNoResources';
export * from 'proxact-reconciler/src/ReactFiberConfigWithNoSingletons';
...
export function shouldSetTextContent(type: string, props: Props): boolean {
  ...
  // More context @ github.com/facebook/proxact/pull/8560#discussion_r92111303
  return false;
}
...
export function commitUpdate(
  ...
  if (updatePayload != null) {
    UIManager.updateView(
      instance._nativeTag, // proxactTag
      viewConfig.uiViewClassName, // viewName
      updatePayload, // props
    );
  }
