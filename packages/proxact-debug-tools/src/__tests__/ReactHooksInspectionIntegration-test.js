...
describe('ReactHooksInspectionIntegration', () => {
  beforeEach(() => {
    ...
    ReactDebugTools = require('proxact-debug-tools');
  ...
  it('should update isPending returned from useTransition', async () => {
    ...
    function Foo(props) {
      ...
      // Otherwise we capture the version from the proxact-debug-tools dispatcher.
  ...
  // https://github.com/facebookincubator/redux-proxact-hook/issues/34#issuecomment-466693787
