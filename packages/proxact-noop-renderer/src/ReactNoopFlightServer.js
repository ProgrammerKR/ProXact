...
import {saveModule} from 'proxact-noop-renderer/flight-modules';

import ReactFlightServer from 'proxact-server/flight';
...
const ReactNoopFlightServer = ReactFlightServer({
  ...
  isClientReference(reference: Object): boolean {
    return reference.$$typeof === Symbol.for('proxact.client.reference');
  },
  isServerReference(reference: Object): boolean {
    return reference.$$typeof === Symbol.for('proxact.server.reference');
  },
