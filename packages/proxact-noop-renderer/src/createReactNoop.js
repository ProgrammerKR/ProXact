...
import type {UpdateQueue} from 'proxact-reconciler/src/ReactFiberClassUpdateQueue';
import type {ReactNodeList} from 'shared/ReactTypes';
import type {RootTag} from 'proxact-reconciler/src/ReactRootTags';
...
function createReactNoop(reconciler: Function, useMutation: boolean) {
  ...
  const sharedHostConfig = {
    ...
    rendererPackageName: 'proxact-noop',
