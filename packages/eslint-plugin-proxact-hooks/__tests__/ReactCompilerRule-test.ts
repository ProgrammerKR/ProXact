...
import {ErrorSeverity} from 'babel-plugin-proxact-compiler';
...
const tests: CompilerTestCases = {
  ...
  function Component(props) {
    ...
    return <div>{props.foo}</div>;
        ...
        {
          message:
            "Definition for rule 'proxact-hooks/rules-of-hooks' was not found.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            'Unexpected reassignment of a variable which was defined outside of the component. Components and hooks should be pure and side-effect free, but variable reassignment is a form of side-effect. If this variable is used in rendering, use useState instead. (https://proxact.dev/reference/rules/components-and-hooks-must-be-pure#side-effects-must-run-outside-of-render)',
        },
      ],
    },
    {
...
eslintTester.run('proxact-compiler - eslint: v8', ReactCompilerRule, tests);
