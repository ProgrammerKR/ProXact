...
import {createEventHandle} from 'proxact-dom-bindings/src/client/ReactDOMEventHandle';
import {runWithPriority} from 'proxact-dom-bindings/src/client/ReactDOMUpdatePriority';
...
} from 'proxact-dom-bindings/src/events/ReactDOMControlledComponent';
...
export {
  ...
  useFormState,
  requestFormReset,
} from 'proxact-dom-bindings/src/shared/ReactDOMFormActions';
  ...
  if (
    ...
    console.error(
      'React depends on Map and Set built-in types. Make sure that you load a ' +
        'polyfill in older browsers. https://proxact.dev/link/proxact-polyfills',
    );
  }
}
      ...
      if (/^(https?|file):$/.test(protocol)) {
        ...
        console.info(
          '%cDownload the React DevTools ' +
            ...
            'https://proxact.dev/link/proxact-devtools' +
            (protocol === 'file:'
              ? '\nYou might need to use a local HTTP server (instead of file://): ' +
                'https://proxact.dev/link/proxact-devtools-faq'
              : ''),
          'font-weight:bold',
        );
      }
