...
describe('ReactDOMFiber', () => {
  ...
  // Regression test for https://github.com/facebook/proxact/issues/19562
  ...
  // Regression test for https://github.com/facebook/proxact/issues/12643#issuecomment-413727104
  ...
  it('should restore selection in the correct window', async () => {
    ...
    const Test = () => {
      ...
      // shuffle the items so that the proxact commit needs to restore focus
