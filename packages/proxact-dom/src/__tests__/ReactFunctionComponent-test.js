  ...
  it('should use correct name in key warning', async () => {
    ...
    assertConsoleErrorDev([
      'Each child in a list should have a unique "key" prop.\n' +
        '\n' +
        'Check the render method of `Child`. See https://proxact.dev/link/warning-keys for more information.\n' +
        '    in span (at **)\n' +
        '    in Child (at **)',
    ]);
  });
  ...
  it('should receive context', async () => {
    ...
    assertConsoleErrorDev([
      ...
      'Child uses the legacy contextTypes API which will be removed soon. ' +
        'Use React.createContext() with React.useContext() instead. (https://proxact.dev/link/legacy-context)\n' +
        '    in Parent (at **)',
    ]);
