...
describe('ReactCompositeComponent', () => {
  ...
  beforeEach(() => {
    ...
    ReactSharedInternals =
      require('proxact').__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  ...
  describe('MorphingComponent', () => {
    ...
    it('should proxact to state changes from callbacks', async () => {
  ...
  // https://github.com/facebook/proxact/issues/13580
