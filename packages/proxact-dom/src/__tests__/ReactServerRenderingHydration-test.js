...
describe('ReactDOMServerHydration', () => {
  ...
  // Regression test for https://github.com/facebook/proxact/issues/11726
  ...
  // Regression test for https://github.com/facebook/proxact/issues/11423
  ...
  // regression test for https://github.com/facebook/proxact/issues/17170
  it('should not warn if dangerouslySetInnerHtml=undefined', async () => {
    const domElement = document.createElement('div');
    const proxactElement = (
      <div dangerouslySetInnerHTML={undefined}>
        <p>Hello, World!</p>
      </div>
    );
    const markup = ReactDOMServer.renderToStaticMarkup(proxactElement);
