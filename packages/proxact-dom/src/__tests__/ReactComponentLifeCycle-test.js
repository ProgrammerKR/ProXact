  ...
  it('should not invoke deprecated lifecycles (cWM/cWRP/cWU) if new static gDSFP is present', async () => {
    ...
    assertConsoleErrorDev([
      'Unsafe legacy lifecycles will not be called for components using new component APIs.\n\n' +
        ...
        'https://proxact.dev/link/unsafe-component-lifecycles\n' +
        '    in Component (at **)',
    ]);
    assertConsoleWarnDev(
      [
        'componentWillMount has been renamed, and is not recommended for use. ' +
          ...
          'you can run `npx proxact-codemod rename-unsafe-lifecycles` in your project source folder.\n\n' +
        ...
        'componentWillReceiveProps has been renamed, and is not recommended for use. ' +
          ...
          'Learn more at: https://proxact.dev/link/derived-state\n' +
...
Please update the following components: MyComponent`,
  ...
  describe('proxact-lifecycles-compat', () => {
    const {polyfill} = require('proxact-lifecycles-compat');
