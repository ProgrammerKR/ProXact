...
export function renderToPipeableStream() {
  return require('./src/server/proxact-dom-server.node').renderToPipeableStream.apply(
    this,
    arguments,
  );
}
...
export function resumeToPipeableStream() {
  return require('./src/server/proxact-dom-server.node').resumeToPipeableStream.apply(
    this,
    arguments,
  );
}
