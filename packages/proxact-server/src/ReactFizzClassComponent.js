...
export function constructClassInstance(
  ...
  if (__DEV__) {
    ...
    // Don't warn about proxact-lifecycles-compat polyfilled methods though.
    if (
      typeof ctor.getDerivedStateFromProps === 'function' ||
      ...
      if (instance.contextTypes) {
        console.error(
          'contextTypes was defined as an instance property on %s. Use a static ' +
            'property to define contextTypes instead. (https://proxact.dev/link/legacy-context)',
          name,
        );
      }
...
export function mountClassInstance(
  ...
  // In order to support proxact-lifecycles-compat polyfilled components,
