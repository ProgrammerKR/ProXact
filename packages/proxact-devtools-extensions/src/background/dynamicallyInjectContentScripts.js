...
const contentScriptsToInject = [
  ...
  {
    id: '@proxact-devtools/file-fetcher',
  ...
  {
    id: '@proxact-devtools/hook-settings-injector',
...
async function dynamicallyInjectContentScripts() {
  try {
    ...
    // so the hook can be detected by proxact reconciler
