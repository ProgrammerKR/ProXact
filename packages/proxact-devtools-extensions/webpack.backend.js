...
const SourceMapIgnoreListPlugin = require('proxact-devtools-shared/SourceMapIgnoreListPlugin');
...
module.exports = {
  ...
  output: {
    ...
    filename: 'proxact_devtools_backend_compact.js',
  },
  node: {
    global: false,
  },
  ...
  plugins: [
    ...
    new Webpack.DefinePlugin({
      ...
      'process.env.DEVTOOLS_PACKAGE': `"proxact-devtools-extensions"`,
