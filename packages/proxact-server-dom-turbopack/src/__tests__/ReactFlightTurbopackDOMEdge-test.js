...
describe('ReactFlightTurbopackDOMEdge', () => {
  beforeEach(() => {
    ...
    jest.mock('proxact-server-dom-turbopack/server', () =>
      require('proxact-server-dom-turbopack/server.edge'),
    );
    ...
    ReactServerDOMServer = require('proxact-server-dom-turbopack/server.edge');
    ...
    ReactServerDOMClient = require('proxact-server-dom-turbopack/client.edge');
    use = React.use;
  });
