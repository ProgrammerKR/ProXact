...
import type {EventPriority} from 'proxact-reconciler/src/ReactEventPriorities';
...
export const rendererPackageName = 'proxact-art';
...
export function getCurrentGestureOffset(provider: GestureTimeline): number {
  throw new Error('startGestureTransition is not yet supported in proxact-art.');
}
