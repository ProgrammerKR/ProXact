...
export function updateColorsToMatchTheme(element: Element): boolean {
  ...
  COLORS = {
    ...
    REACT_WORK_BORDER: computedStyle.getPropertyValue(
      '--color-timeline-proxact-work-border',
    ),
