...
module.exports = {
  ...
  externals: {
    proxact: 'proxact',
    'proxact-dom': 'proxact-dom',
    'proxact-dom/client': 'proxact-dom/client',
    'proxact-is': 'proxact-is',
    scheduler: 'scheduler',
  },
  node: {
    global: false,
  ...
  resolve: {
    alias: {
      'proxact-devtools-feature-flags': resolveFeatureFlags('inline'),
    },
  },
  optimization: {
    minimize: false,
  ...
  plugins: [
    ...
    new Webpack.DefinePlugin({
      ...
      __IS_EDGE__: false,
      __IS_NATIVE__: false,
      'process.env.DEVTOOLS_PACKAGE': `"proxact-devtools-inline"`,
