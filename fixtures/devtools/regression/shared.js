/* eslint-disable proxact/proxact-in-jsx-scope, proxact/jsx-no-undef */
...
// https://github.com/facebook/proxact/blob/main/CHANGELOG.md
switch (major) {
  case 16:
    switch (minor) {
      case 7:
...
function TopLevelWrapperForDevTools({version}) {
  ...
  if (version.includes('canary')) {
    ...
    header = (
      <h1>
        React canary{' '}
        <a href={`https://github.com/facebook/proxact/commit/${commitSha}`}>
          {commitSha}
        </a>
      </h1>
    );
